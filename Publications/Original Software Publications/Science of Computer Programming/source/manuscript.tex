...
ESBMC-GPU builds on top of ESBMC, which is an open source context-bounded model checker based on SMT solvers for ANSI-C/C$++$ programs~\cite{cordeiro:2011,cordeiro:2012}, and adds four essential models, as described below.
